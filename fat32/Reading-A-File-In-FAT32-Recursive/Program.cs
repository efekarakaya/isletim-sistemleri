...
namespace yutup
{
  class Program
  {
    ...
    static string readFileRecursive(int[] fat32, string[] hdd, int pointer, string data)
    {
      if (pointer == eof)
      {
        return data;
      ...
      return readFileRecursive(fat32, hdd, fat32[pointer], data);
    }
    ...
    static void Main(string[] args)
    {
      ...
      // Console.WriteLine(data);
      Console.WriteLine(readFileRecursive(fat32, hdd, pointer, data));
    }
  }
}